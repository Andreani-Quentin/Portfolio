...
<html lang="fr">
	<body>
		<head>
			<title>Andreani Quentin || Développpeur Web</title>
			<meta charset="UTF-8">
		...
		<section class="presentation pt-5" id="startchange">
			<div class="container py-5">
				...
				<div class="row mb-5">
					...
					<div class="col-md-6 text-center"><img class="shadow-lg mt-3 pt-3" src="styles/images/moi.jpeg" alt="Andreani Quentin"></div>
				</div>
				<div class="row end">
